  ...
  <div class="row">
      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	<?php echo form_open_multipart('Kelas/update/'.$getData['id']); ?>
			<div class="form-group">
				<label class="col-md-4 control-label" for="nama">Nama Kelas</label>  
				<div class="col-md-5">
			  <input id="nama" name="nama_kelas" type="text" value="<?php echo $getData['nama_kelas'] ?>" placeholder="Nama Kelas" class="form-control input-md" required="">
			  </div>
			</div><br><br>
