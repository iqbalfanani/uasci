  ...
  <div class="row">
      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	 <a href="<?php echo base_url() ?>index.php/Murid/insert" class="btn btn-primary my-3">Tambah</a> <br><br>
		    <table class="table table-striped table-hover" id="table_id">
		      ...
		      <tbody>
		        <?php foreach ($murid_list as $key => $value):?>
		        <tr>
		          ...
		          <td><img src="<?php echo base_url('assets/img/murid/').$value['foto'] ?>" width="50" height="50" alt=""></td>
		          <td>
		          	<a href="<?php echo base_url() ?>index.php/Murid/update/<?php echo $value['id'] ?>" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-pencil"></span>
					      <a href="<?php echo base_url() ?>index.php/Murid/delete/<?php echo $value['id'] ?>"class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
		          </td>
		        </tr>
		      <?php endforeach ?>
		      </tbody>
