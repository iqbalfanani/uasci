      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  <div class="panel-heading"style="background-color:  #1E8BC3;">
		    <h3 class="panel-title">Update Kelas</h3>
		  </div>
		  <div class="panel-body">
		  	<?php echo form_open_multipart('Mapel/update/'.$getData['id']); ?>
			<div class="form-group">
				<label class="col-md-4 control-label" for="nama">Nama Mapel</label>  
				<div class="col-md-5">
			  <input id="nama" name="nama_mapel" type="text" value="<?php echo $getData['nama_mapel'] ?>" placeholder="Nama Mapel" class="form-control input-md" required="">
			  </div>
			</div><br><br>
