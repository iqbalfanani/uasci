...
<div class="container-fluid column-starter">
  ...
  <div class="row">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
         <a href="<?php echo base_url() ?>index.php/User/insert" class="btn btn-primary my-3">Tambah</a> <br><br>
        <table class="table table-striped table-hover" id="table_id">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo base_url() ?>index.php/User/update/<?php echo $value['id'] ?>" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-pencil"></span>
                <a href="<?php echo base_url() ?>index.php/User/delete/<?php echo $value['id'] ?>"class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
              </td>
            </tr>
          <?php endforeach ?>
          </tbody>
