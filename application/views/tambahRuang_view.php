  ...
  <div class="row">
      ...
      <div class="col-md-9">
    		<div class="panel panel-default">
    		  ...
    		  <div class="panel-body">
    		  	<?php echo form_open_multipart('Ruang/insert'); ?>
    			<div class="form-group">
    				<label class="col-md-4 control-label" for="nama">Nama Ruang</label>  
    				<div class="col-md-5">
    			  <input id="nama" name="no_ruang" type="text" placeholder="Nama Ruang" class="form-control input-md" required="">
    			 </div>
          <div class="form-group">
            <label class="col-md-4 control-label" for="nama">Kapasitas</label>  
            <div class="col-md-5">
            <input id="nama" name="kapasitas" type="text" placeholder="Kapasitas" class="form-control input-md" required="">
            </div>
    			</div><br><br>
