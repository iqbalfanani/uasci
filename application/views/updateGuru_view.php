      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  <div class="panel-heading"style="background-color:  #1E8BC3;">
		    <h3 class="panel-title">Tambah Guru Baru</h3>
		  </div>
		  <div class="panel-body">
		  	<?php echo validation_errors(); ?>
		  	<?php echo form_open_multipart('Guru/update/'.$getData['id']); ?>
			<div class="form-group">
				<label class="col-md-4 control-label" for="nama">Nama Lengkap</label>  
				<div class="col-md-5">
			  <input id="nama" name="nama_guru" type="text" value="<?php echo $getData['nama_guru'] ?>" placeholder="Nama Lengkap Anda" class="form-control input-md" >
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="alamat" name="alamat" type="text" value="<?php echo $getData['alamat'] ?>" placeholder="Alamat Anda" class="form-control input-md" >
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="tanggal" name="tanggal" type="date" value="<?php echo $getData['tanggal'] ?>" placeholder="tanggal" class="form-control input-md" >
			...
			<!-- Text input-->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="telp">No HP</label>  
			  <div class="col-md-5">
			  <input id="telp" name="telp" type="text" value="<?php echo $getData['telp'] ?>" placeholder="No Handphone Anda" class="form-control input-md" >
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="gender" value="<?php echo $getData['jenisKelamin'] ?>">Jenis Kelamin</label>
			  <div class="col-md-5"> 
