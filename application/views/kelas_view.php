  ...
  <div class="row">
      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	 <a href="<?php echo base_url() ?>index.php/Kelas/insert" class="btn btn-primary my-3">Tambah</a> <br><br>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
		          	<a href="<?php echo base_url() ?>index.php/Kelas/update/<?php echo $value['id'] ?>" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-pencil"></span>
                <a href="<?php echo base_url() ?>index.php/Kelas/delete/<?php echo $value['id'] ?>"class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
		          </td>
		        </tr>
		      <?php endforeach ?>
		      </tbody>
