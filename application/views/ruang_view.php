  ...
  <div class="row">
      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	 <a href="<?php echo base_url() ?>index.php/Ruang/insert" class="btn btn-primary my-3">Tambah</a> <br><br>
          ...
          <tbody>
            <?php foreach ($ruang_list as $key => $value):?>
            <tr>
              <td><?php echo $value['id'] ?></td>
              <td><?php echo $value['no_ruang'] ?></td>
              <td><?php echo $value['kapasitas'] ?></td>
              <td>
		          	<a href="<?php echo base_url() ?>index.php/Ruang/update/<?php echo $value['id'] ?>" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-pencil"></span>
                <a href="<?php echo base_url() ?>index.php/Ruang/delete/<?php echo $value['id'] ?>"class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>
		          </td>
		        </tr>
		      <?php endforeach ?>
		      </tbody>
