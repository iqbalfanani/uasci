  ...
  <div class="row">
      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	<?php echo form_open_multipart('Murid/update/'.$getData['id']); ?>
			<div class="form-group">
				<label class="col-md-4 control-label" for="nama">Nama Lengkap</label>  
				<div class="col-md-5">
			  <input id="nama" name="nama_murid" type="text" value="<?php echo $getData['nama_murid'] ?>" placeholder="Nama Lengkap Anda" class="form-control input-md" required="">
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="alamat" name="alamat" type="text" value="<?php echo $getData['alamat'] ?>" placeholder="Alamat Anda" class="form-control input-md" required="">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="tanggal" name="tanggal" type="date" value="<?php echo $getData['tanggal'] ?>" placeholder="tanggal" class="form-control input-md" required="">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="telp" name="telp" type="text" value="<?php echo $getData['telp'] ?>" placeholder="No Handphone Anda" class="form-control input-md" required="">
			...
			<div class="form-group">
			  ...
			  <select class="form-control" id="jenjang" name="jenjang" >
			    <option><?php echo $getData['jenjang'] ?></option>
			    <option>SD</option>
			    <option>SMP</option>
			    <option>SMA</option>
			  </select>
			...
			<!-- <div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="username" name="username" type="text" value="<?php echo $getData['username'] ?>" placeholder="Your username" class="form-control input-md" required="">
			...
			<!-- <div class="form-group">
			  ...
			  <div class="col-md-5">
			    <input id="text" name="password" type="password" value="<?php echo $getData['password'] ?>" placeholder="Password" class="form-control input-md" required="">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input type="file" class="form-control-file" value="" id="exampleFormControlFile1" name="foto">
