      ...
      <div class="col-md-9">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	...
		  	<?php echo form_open_multipart('Home/update/'.$getData['id']); ?>
      <!-- Drop Down <input--></input-->
      <div class="form-group">
        <label class="col-md-4 control-label" for="fk_id_ruang">Ruang</label>  
        <div class="col-md-5">
        <select name="fk_id_ruang" id="fk_id_ruang" class="form-control" value="<?php echo $getData['no_ruang'] ?>" >
          ...
          <?php endforeach ?>
			...
			<!-- Drop Down input-->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="fk_id_guru">Nama Guru</label>  
			  <div class="col-md-5">
			  <select name="fk_id_guru" id="fk_id_guru" class="form-control" value="<?php echo $getData['nama_guru'] ?>">
